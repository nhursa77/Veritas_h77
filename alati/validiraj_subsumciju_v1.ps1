...
<#
.SYNOPSIS
Kompatibilni wrapper za `subsumcija_v*.json` validaciju.

.DESCRIPTION
Zadrzava postojece ime validatora i delegira schema-driven provjeru na
`validiraj_json_po_shemi_v1.ps1` uz `SCHEMA_SUBSUMPCIJA_V1.json`.
...
$opis = "subsumcija v1 wrapper prema generickom schema-driven validatoru"
