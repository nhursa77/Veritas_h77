...
<#
.SYNOPSIS
Kompatibilni wrapper za `postupak.json` validaciju.

.DESCRIPTION
Zadrzava postojece ime validatora i delegira schema-driven provjeru na
`validiraj_json_po_shemi_v1.ps1` uz `SCHEMA_POSTUPAK_V1.json`.
...
$opis = "postupak v1 wrapper prema generickom schema-driven validatoru"
