...
STATUS_ZATVORENO = "SLJEDECA_POTPUNO_VALIDIRANA_NATUKNICA_ZATVORENA"
STATUS_NEZATVORENO = "NIJE_PRONADEN_KANDIDAT"
...
def run(
    ...
    if eligible:
        ...
        status = STATUS_ZATVORENO
        reason_selected = (
            "Kandidat je odabran deterministicki nakon iskljucenja vec zatvorenih "
            "natuknica, po sortiranju kanonski_naziv_podnatuknice pa clanak."
        )
    else:
        reason_if_not_closed = (
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Deterministicki zatvara sljedecu potpuno validiranu gransku natuknicu "
