...
<#
.SYNOPSIS
Kompatibilni wrapper za `intake_v*.json` validaciju.

.DESCRIPTION
Zadrzava postojece ime validatora i delegira schema-driven provjeru na
`validiraj_json_po_shemi_v1.ps1` uz `SCHEMA_INTAKE_PREKRSAJI_V1.json`.
...
$opis = "intake prekrsaji v1 wrapper prema generickom schema-driven validatoru"
